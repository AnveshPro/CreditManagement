...
if($var1>= $credit1 && strcmp($name1,$name2)!=0){ 
$deduct_query = "UPDATE users SET totalcredit = totalcredit -'$credit1' where name  = '$name1' " ; 
...
if($con3->query($deduct_query) === TRUE && $con3->query($add_query) === TRUE && $con3->query($transaction_query)===TRUE){
  ...
  echo "Error updating record: " . $con3->error;
	...
	echo '<script> window.alert("Insufficient Balance or same sender and receiver") </script>';
